            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="action-button">
                        <a href="" class="btn button btn-primary btn-white" style="background: #ffffff;"><i class="fa fa-send"></i> Register Now.!</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="testimonial-wrapper navigation-one text-center">
                        ...
                        @foreach($testimonial as $key => $t)
                            <div class="single-testimonial">
                                <blockquote>
                                    <img src="{{ asset('images/testimonial') }}/{{ $t->image }}" alt="{{ $t->name }}" class="client-image">
                                    <p>{{ $t->message }}</p>
                    ...
                    <div class="col-md-4 col-sm-6" style="margin-bottom: 20px;">
                        <article class="blog-post">
                            ...
                            <div class="post-content">
                                <h5 class="post-title"><a href="">{{ substr($b->title,0,30) }}{{ strlen($b->title) > 33 ? '...' : '' }}</a></h5>
