            ...
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-sm-3 text-right control-label bold uppercase">Parent Category : </label>
                            <div class="col-sm-8">
                                <select name="parent_id" id="parent_id" class="form-control has-error" >
    ...
    <script>
        ...
        $(document).on('click','.open_modal',function(){
            ...
            $.get(url + '/' + product_id, function (data) {
                ...
                if(product_id){
                    $("#parent_id option").css('display','block');
                    $("#parent_id option[value='"+product_id +"']").css('display','none');
                }
                else
                {
                    $("#parent_id option").css('display','block');
        ...
        $("#btn-save").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    window.location.replace('/admin/manage-category');
                },
                error: function(data)
                {
